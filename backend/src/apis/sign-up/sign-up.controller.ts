...
export async function signupProfileController (request: Request, response: Response) {
	try {
		...
		const { profileName, profileEmail, profilePassword, profileId } = request.body
		...
		const profileImageUrl = 'https://res.cloudinary.com/cnm-ingenuity-deep-dive-bootcamp/image/upload/v1726159504/t32ematygvtcyz4ws9p5.png'
